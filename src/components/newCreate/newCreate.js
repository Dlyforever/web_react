...
class BiddingCreate extends React.Component {
    ...
    clear(rulenum, index) {
        let num1 = this.state.num1;
        num1[index][rulenum] = ''
        this.setState({num1:num1}, () => {this.props.onDelOne(this.state.num1)})
    }
    onChangeInput(rulenum, e) {
        ...
        this.setState({modalinput:modalinput})
    }
    urlParme2Obj() {
    ...
    render() {
       ...
       <Modal
        ...
        >
          ...
          <Button className='ant-btn ant-btn-lg' onClick={this.handleCancel1.bind(this)}>{this.state.cancel[this.state.lang]}</Button>
          <Button className='ant-btn ant-btn-primary ant-btn-lg' onClick={this.handleOk1.bind(this)}>{this.state.confirm[this.state.lang]}</Button>
          </div>
        </Modal>
                </div>);
        return (
