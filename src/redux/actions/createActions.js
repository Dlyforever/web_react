...
import {
  ...
  GET_EVIDEINFO_REQUESTED,
  GET_EVIDEINFO_SUCCEEDED
} from './actionTypes';
...
// 搜索弹出舆情
export const yvqingListRequested = createAction(GET_SEARCHEJCT_YUQING_REQUESTED)
export const yvqingListSucceeded = createAction(GET_SEARCHEJCT_YUQING_SUCCEEDED)
// 搜索弹出分类
export const classifyRequested = createAction(GET_SEARCHEJCT_CLASSIFY_REQUESTED)
export const classifySucceeded = createAction(GET_SEARCHEJCT_CLASSIFY_SUCCEEDED)
// 搜索弹出专题
export const specialRequested = createAction(GET_SEARCHEJCT_SPECIAL_REQUESTED)
export const specialSucceeded = createAction(GET_SEARCHEJCT_SPECIAL_SUCCEEDED)
//取证路由信息
export const evideinfoRequested = createAction(GET_EVIDEINFO_REQUESTED)
export const evideinfoSucceeded = createAction(GET_EVIDEINFO_SUCCEEDED)
