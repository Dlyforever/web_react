...
////取证路由信息
export const evideinfoRequested = handleAction(GET_EVIDEINFO_REQUESTED, (state, action) => ({
  data: action.payload
}),'1')
export const evideinfoSucceeded = handleAction(GET_EVIDEINFO_SUCCEEDED, (state, action) => ({
  data: action.payload
}),{data: {}})
export {
