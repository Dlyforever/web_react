...
const Multilingual= AsyncComponent(() => import('../Multilingual/MultilingualInfo'))
const Organizational = AsyncComponent(() => import('../Organizational/Organizational'))
const UploadReport = AsyncComponent(() => import('../UploadReport/uploadReport'))
  ...
  render() {
    ...
    this.state.channelList.map((item, index) => {
      if (item.channelurl === '/allopinion/reportopinion/list') {
        ...
        menuList.push(<SubMenu key={item.key}  className={haverClass}
          ...
          <Menu.Item key="organizational" style={{fontSize: '16px'}}>
            <Link to="/allopinion/organizational">
              <span>组织架构</span>
            </Link>
          </Menu.Item>
        </SubMenu>)
      ...
      //       </SubMenu>)
      // } 
      else if (item.channelurl === '/allopinion/evidencemanagement/interent/0') {
        menuList.push(<SubMenu key={item.key}  className={haverClass}
          title={<Link to="/allopinion/evidencemanagement/interent/0"><span><i className="anticon"><Iconfont type={item.type}
            style={{fontSize: '16px'}}/></i><span
            style={{fontSize: '16px'}}>取证</span></span> </Link>}>
            <Menu.Item key="evidadmin" style={{fontSize: '16px'}}>
            <Link to="/allopinion/evidadmin">
            <span>互联网取证</span>
            </Link>
            </Menu.Item>
            <Menu.Item key="interent" style={{fontSize: '16px'}}>
            <Link to="/allopinion/evidencemanagement/interent/0">
            <span>证据管理</span>
            </Link>
            </Menu.Item>
            </SubMenu>)
    ...
    return (
      <div style={{display:'flex',width:"100%",height:'100%'}}>
            ...
            trigger={null}
            style={{position: 'fixed', left: 0,backgroundColor: themeColor.leftColor.backgroundColor}}
          ...
          >
            <div>
              ...
              style={{backgroundColor:themeColor.leftColor.backgroundColor}}
              >
            ...
            <Menu
              ...
              mode="inline"
              style={ {backgroundColor: themeColor.leftColor.backgroundColor, overflow: 'auto',maxHeight: '600px',border:'none'}}
          ...
          <Layout style={this.state.collapsed&&this.state.flag?{marginLeft:'64px',background:'#E4EbF7',overflowX:'inherit'}:{marginLeft:'200px',background:'#E4EbF7',overflowX:'inherit'}}>
          <Content>
          <Switch>
                ...
                <Route path="/allopinion/multilingual/:languages" component={Multilingual}/>
                <Route path="/allopinion/organizational" component={Organizational}/>
                <Route path="/allopinion/uploadReport" component={UploadReport}/>
              </Switch>
              </Content>
              </Layout>
