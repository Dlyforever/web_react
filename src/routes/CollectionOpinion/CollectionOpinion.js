...
class CollectionOpinion extends React.Component {
    ...
    handleAddCollectionSubmit() {
        this.props.form.validateFields((err, values) => {
            if (!err) {
                if(values.CollectionName.length>=14){
                    message.error('文件夹名称请不要超过14个字符');
                    return;
                }
    ...
    // 获取报告列表
    getReportOpinionList() {
        this.props.getReportListRequested({pagesize:100});
    }
        ...
        return (<div className="collection-opinion-wrapper">
            <div className="collection-opinion">
                ...
                <b>{this.state.checkedLength}</b>
                            ...
                            {/* <div className="operate-all" onClick={this.getReportOpinionList.bind(this)}>
                                    ...
                                    <FormItem {...formItemLayout} label="收藏夹名称">
                                        {
                                            ...
                                            })(<Input onChange={this.CollectionChange.bind(this)} />)
                                        }
                                    </FormItem>
                                </Form>
                            </Modal>
