...
import {setInformTime} from '../../utils/localStorage';
class NewHome extends React.Component {
                          ...
                          .then((res) => {
                            ...
                            .then( res => {
                              ...
                              this.setState({
                                ...
                                request(api_count_charts,{
                                  method: 'POST',
                                  headers: {
                                        "Content-Type": "application/x-www-form-urlencoded"
                                  }, 
                                  body:`data=${JSON.stringify(res.data.all)}`
                                }).then(res => {
                                  if(res.data.code === 1){
                                    this.setState({
  ...
  render() {
    ...
    const {userInfo,themeColor,isShowTime} = this.props;
    ...
    return (
      <div style={{backgroundColor: themeColor.grounding.color,minHeight:`${innerHeight}px`}}>
        <div className="informs" style={isShowTime?{display:'flex',background:themeColor.confimColor.backgroundColor}:{display:'none'}}>
