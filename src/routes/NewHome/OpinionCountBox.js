...
class OpinionCountBox extends React.PureComponent {
    ...
    render() {
        const {themeColor,data,legend,series,size} = this.props;
            ...
            <div className="opinion-count-box" style={{background:themeColor.bottomColor.backgroundColor}}>
                <div className="container">
                    <div className="top" style={{borderBottom: `1px solid ${themeColor.borderColor.color}`}}>
                        <div className="title">
                            <IconFont type="icon-tongji" style={{fontSize: '18px',color:BLUES,verticalAlign:'-8px'}}/>
                    ...
                    <div className="bottom">
                        <table className="count-table" style={size === 50 ?{width:'100%',color:themeColor.textColor.color}:{width:'60%',color:themeColor.textColor.color}}>
                            <tbody>
                            {data.length > 1 ?
                                data.map((item, index) =>
                        ...
                        <ReactEchartsCore
                            ...
                            option={mediaOption}
                            lazyUpdate={true}
                            style={size === 50 ?{display:'none'}:{height: '310px', width: '40%', marginBottom: '-20px'}}
                            />
                    </div>
                </div>
            </div>
