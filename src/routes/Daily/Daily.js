...
class Daily extends React.Component{
	...
	onChangeCellEditor(e) {
		...
		request(api_update_report + '&reportId=' + this.state.reportId + '&editor=' + e + '&moduleId=' + this.state.dataID).then((res) => {
			if(res.data.code === 1) {
				message.success(res.data.msg);
				jiaData.data[componentId[0]]['coverEditor'] = e;
				this.setState({
					jiaData:jiaData    
				})
			} else {
	...
	onChangeCellMonth(e) {
		...
		request(api_update_report + '&reportId=' + this.state.reportId + '&date=' + editDate + '&moduleId=' + this.state.dataID).then((res) => {
			if(res.data.code === 1) {
				message.success(res.data.msg);
				jiaData.data[componentId[0]]['coverMonth'] = e;
				this.setState({
					jiaData:jiaData    
				})
			} else {
	...
	onChangeCellDay(e) {
		...
		request(api_update_report + '&reportId=' + this.state.reportId + '&date=' + editDate + '&moduleId=' + this.state.dataID).then((res) => {
			if(res.data.code === 1) {
				message.success(res.data.msg);
				jiaData.data[componentId[0]]['coverDay'] = e;
				this.setState({
					jiaData:jiaData    
				})
			} else {
	...
	onChangeCellYear(e) {
		...
		request(api_update_report + '&reportId=' + this.state.reportId + '&date=' + editDate + '&moduleId=' + this.state.dataID).then((res) => {
			if(res.data.code === 1) {
				message.success(res.data.msg);
				jiaData.data[componentId[0]]['coverYear'] = e;
				this.setState({
					jiaData:jiaData    
				})
			} else {
