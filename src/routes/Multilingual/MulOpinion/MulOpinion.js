            ...
            <div className="detail-opinion">
                <div className="wrapper">
                    <div className="Top">
                        ...
                        <Button type="primary" style={parseInt(this.state.languageType, 10) === 3 ? {float: 'left'} : {}} className="btn" onClick={this.toggleLan.bind(this)}>{this.state.languageType-0 === 0 ? this.state.language[this.props.match.params.languages] : '中文'}</Button>
                        <div className={parseInt(this.state.languageType, 10) === 3 ? 'info uygur' : 'info'}>
                            <div className="pubdate" style={parseInt(this.state.languageType, 10) === 3 ? {marginRight: 0} : {}}>
                        ...
                        <div className={parseInt(this.state.languageType, 10) === 3 ? 'keywords uygur' : 'keywords'}>
                        ...
                        <div className={parseInt(this.state.languageType, 10) === 3 ? 'mention-topic uygur' : 'mention-topic'}>
                        ...
                        <div className="operation" className={parseInt(this.state.languageType ,10) === 3 ? 'operation uygurbtn' : 'operation'}>
