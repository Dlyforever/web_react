  ...
  constructor(props) {
    ...
    this.state = {
      ...
      trend: [
        ...
        {
          name: ['预警', '예보', '警報', 'ئالدىن سىگنال بېرىش', 'ཉེ་བརྡ་', 'warning'],
          value: 2
        }
      ],
      trendValue: 'all',
      ...
      <div className="all-opinion2" id="anchor">
        ...
        <div className="sort-top" style={this.state.isTopShow ? {display: 'block'} : {display: 'none'}}>
          <div className={this.state.languageType-0 === 3? 'uygur sort-items' : 'sort-items'}>
            <div className={parseInt(this.state.languageType,10) === 5 ? 'left english' : 'left'}>{this.state.OptiionTitle.time[this.state.languageType]}</div>
            <div className="right">
              {Time()}
            </div>
          ...
          <div className={this.state.languageType-0 === 3? 'uygur sort-items' : 'sort-items'}>
            <div className={parseInt(this.state.languageType,10) === 5 ? 'left english' : 'left'}>{this.state.OptiionTitle.inclination[this.state.languageType]}</div>
            <div className="right">
              {Trend()}
            </div>
          </div>
          <div className={this.state.languageType-0 === 3? 'uygur sort-items' : 'sort-items'}>
            <div className={parseInt(this.state.languageType,10) === 5 ? 'left english' : 'left'}>{this.state.OptiionTitle.sort[this.state.languageType]}</div>
            <div className="right">
              {Sort()}
            </div>
          </div>
          <div className={this.state.languageType-0 === 3? 'uygur sort-items' : 'sort-items'}>
            <div className={parseInt(this.state.languageType,10) === 5 ? 'left english' : 'left'}>{this.state.OptiionTitle.removal[this.state.languageType]}</div>
            <div className="right">
              {Filter()}
            </div>
          </div>
          <div className={this.state.languageType-0 === 3? 'uygur media-items' : 'media-items'}>
            <div className={parseInt(this.state.languageType,10) === 5 ? 'left english' : 'left'}>{this.state.OptiionTitle.media[this.state.languageType]}</div>
            <div className="right">
              {Media()}
            </div>
          </div>
        ...
        <div className="middle">
          ...
          <OpinionDetail docList={docList}
                         ...
                         lang={this.state.language[this.props.match.params.languages]}
                         topicid={this.props.getRouter.topicid}
          />
        </div>
