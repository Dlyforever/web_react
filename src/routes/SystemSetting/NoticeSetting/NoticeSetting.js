...
class NoticeSetting extends React.Component{
    ...
    componentDidMount(){
          request(user_message).then(res=>{
                 ...
                 let config = [];
                 if(res.data.emailConfig.warning === '1') config.push('warning')
                 if(res.data.emailConfig.negative === '1') config.push('negative')
                 this.setState({
                    ...
                    <p className="backgroundBox"> 推送开关</p>
                      ...
                      <p className="backgroundBox">  推送方式</p>
                            <Row >
                               ...
                               <div className="inputBoxs">
                               <FormItem className="timePickerBox">
                                  <CheckboxGroup options={plainOptions} onChange={this.changeConfig} value={this.state.config}/>
                                </FormItem>
                                </div>
                               </Col>
                            </Row>
